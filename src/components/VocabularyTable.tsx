    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mt-6 flex flex-col">
      ...
      <div className="mt-auto px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
        <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">
          Found <span className="text-slate-900">{totalItems}</span> vocabulary entries
        </p>
        <div className="flex gap-1">
          <button
            onClick={() => currentPage > 1 && onPageChange(currentPage - 1)}
            disabled={currentPage === 1}
            className={`${currentPage === 1 && 'opacity-50 cursor-not-allowed'} px-3 py-1 bg-white border border-slate-200 rounded text-[11px] font-bold text-slate-700`}
          >
            Prev
          </button>
          ...
          <button
            ...
            className={`${currentPage === totalPages && 'opacity-50 cursor-not-allowed'} px-3 py-1 bg-white border border-slate-200 rounded text-[11px] font-bold text-slate-700`}
          >
            Next
          </button>
        </div>
